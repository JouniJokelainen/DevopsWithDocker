...
Enviroment variables removed from backend dockerfile (ENV API_URL=http://localhost:8000) and frontend dockerfile (ENV FRONT_URL=http://localhost:5000). Images were rebuiled through docker-compose.  
